...
AND churn_reason IN ('Competitor had better devices','Competitor offered higher download speeds', 'Lack of affordable download/upload speed',
'Limited range of services', 'Product dissatisfaction', 'Service dissatisfaction', 'Network reliability')
GROUP BY city
ORDER BY zip_code;
